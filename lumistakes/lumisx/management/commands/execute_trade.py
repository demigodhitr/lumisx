    ...
    def handle(self, *args, **kwargs):
        ...
        for investment in active_investments:
            try:
                ...
                investment_end = investment.date + timedelta(days=duration_days)
                ...
                elapsed_hours = int((now - investment.date).total_seconds() // 3600)
                ...
                if profit_diff != 0:
                    with transaction.atomic():
                        if random.random() <= 0.7:
                            ...
                            # LOSS
                            loss = abs(profit_diff * investment.losses_rate)
                            investment.total_profits_accrued -= loss
                            balance.profits -= loss

...
urlpatterns = [
    ...
    path('knowledge-center', knowledge_center, name='knowledge-center'),
    ...
    # Demo Account
    path('demo-account', demo_account, name='demo-account'),
    path('demo-trading', demo_trading, name='demo-trading'),
